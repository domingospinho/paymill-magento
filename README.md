...
PAYMILL extension for Magento compatible with: 1.5, 1.6, 1.6.1, 1.6.2.0, 1.7, 1.8, 1.9 (tested for 1.9.3.6). This extension installs two payment methods: Credit card and direct debit.
